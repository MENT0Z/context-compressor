...
// popup.js
// Flow:
//   1. User clicks "① Extract"  → asks content.js for raw messages → stores them
//   2. User clicks "② Process"  → sends messages to background.js → calls runExtractor()
//   3. Result is displayed in <pre id="result">

// let extractedData = null; // holds the raw data from content.js between steps
...
//     if (!key) { setStatus("Please paste your Gemini API key first.", "error"); return; }
...
//         setStatus("API key saved to extension storage.", "success");
...
//         extractedData = res;
//         showResult(res); // show raw extracted data immediately
...
//             showResult(res.data);
//             setStatus("✓ Done — compressed context shown below.", "success");
//         }
//     );
// };
